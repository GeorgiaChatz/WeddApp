...
""", unsafe_allow_html=True)
# Form
guest_list = ["Κοσμάς Κουβαράς", "Χρήστος Αρώνης", "Γιάννης Θεοδώρου","Γεωργία Θεοδώρου","Κώστας Μεσσανάκης","Παναγιώτης Μυλωνάς","Βασίλης Γεωργακόπουλος", "Αναστάσης Τσέλιος", "Χαράλαμπος Τσαφάς", "Αντώνης Καπογιαννάτος", "Φιλοθέη Κόσσυφα", "Ειρήνη Τζανέτου", "Γιώργος Μαρτζούκος", "Αθηνά Καμηλέλλη", "Θάλεια Λαμπίδη", "Ντίνα Τίτση", "Τατιάνα Γιαννούλη", "Πάνος Σαλτερής", "Δημήτρης Χριστόπουλος", "Στέφανος Γιώτης", "Γιώργος Γκολφόπουλος", "Μαρία Τσαρδίκου", "Μηνάς Καλωσυνάκης", "Κωσταντίνα", "Ελευθερία Κούρσαρη", "Άννα Μπουρλή", "Ιωάννα Μπουρλή", "Luca Canalini", "Sylvia Andaloro", "Lucia Cordoba-Esteban", "Βάγια Ξεβγένη", "Βασιλίνα Σωτηροπούλου", "Παναγιώτα Χάιδα", "Αλέξανδρος Βέρρας", "Πάολα Μερτίρι", "Σπυριδούλα Βλατάκη", "Αλέξης Σουρτζής", "Ανθή Χατζηιωάννου", "Άννα Μπουργανού", "Αναστάσης Χαλδούπης", "Γιούλα Κωσταντοπούλου", "Αλεξία Καλαντζή", "Ντόρα Καλαντζή", "Γιώργος Καλαντζής", "Παναγιώτης Καλαντζής", "Δημήτρης Καλαντζής", "Άννα Κούσουλα", "Χρήστος Σκουφαρίδης", "Δημήτρης Μποιντάς", "Μιχάλης Αλεξόπουλος", "Θοδωρής Θεοδωρίδης", "Δημήτρης Παπαδημητρίου", "Ιφιγένεια Ισαμπάλογλου", "Γιάννης Μπόσκοβιτς", "Λάζαρος Γιάβρο","Άκης Θεοδώρου", "Άκης Καραουλάνης","Βασίλης Μητρόπουλος","Χρήστος Θεοφιλόπουλος","Παναγιώτης Τζίνης","Γιάννης Φούντας"
]
with st.form("attendance_form"):
    name = st.selectbox(texts[lang]["select_name"], guest_list)
    adults = st.number_input(texts[lang]["adults"], min_value=1, max_value=10, value=1)
